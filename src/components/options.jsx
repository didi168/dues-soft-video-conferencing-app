...
const Options = () => {
    ...
    const startCall = () => {
        // Emit an event to the server to start the call and generate a call ID
        callUser();
    };
                    ...
                    <Grid templateColumns='repeat(2, 1fr)' mt="12">
                        <Grid colSpan={1} p="6">
                            ...
                            <CopyToClipboard text={me}>
                                <Button leftIcon={<BiClipboard />} colorScheme='teal' variant='solid' mt="20">
                                    Copy ID
                                </Button>
                            </CopyToClipboard>
                        </Grid>
                        <Grid colSpan={1} p="6">
                            ...
                            <Input type='text' value={idToCall} onChange={(e) => setIdToCall(e.target.value)} width="100%" />
                            {
                                callAccepted && !callEnded ? (
                                    ...
                                    <Button leftIcon={<BiPhoneCall />} onClick={startCall} mt="20" colorScheme='teal' variant='solid'>
                                        Start Call
                                    </Button>
                                )
                            }
                            <CopyToClipboard text={idToCall}>
                                <Button leftIcon={<BiClipboard />} colorScheme='teal' variant='solid' mt="2">
                                    Copy Call ID
                                </Button>
                            </CopyToClipboard>
                        </Grid>
